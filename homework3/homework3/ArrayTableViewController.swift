...
class SubAnimal : Animal {
    ...
    override func prettyAnimalName() -> String {
        return "My pet is called: " + self.name
    }
...
class ArrayTableViewController: UITableViewController {
    ...
    */
    let animalArray = [
        Animal(name: "Rover"), Animal(name: "Mittens"), Animal(name: "Ein"), Animal(name: "Sadie"),
        SubAnimal(name: "Sparkles"),
        SubAnimal(name: "DeathStar"),
        SubAnimal(name: "WompaDoodle"),
        SubAnimal(name: "Xavier"),
        SubAnimal(name: "Null-the-cat")
    ]
